...
export default function Pricing() {
  const airportPricing = [
    {
      id: "dabolim-north",
      title: "Dabolim Airport to North Goa",
    ...
    {
      id: "dabolim-south",
      title: "Dabolim Airport to South Goa",
      image: "/dabolim.png?height=200&width=300",
    ...
    {
      id: "mopa-north",
      title: "Mopa Airport to North Goa",
    ...
    {
      id: "mopa-south",
      title: "Mopa Airport to South Goa",
      image: "/mopa.png?height=200&width=300",
      description: "Colva, Benaulim, Palolem",
      price: "₹1800 - ₹2200",
  ...
  const railwayPricing = [
    {
      id: "madgaon-north",
      title: "Madgaon Station to North Goa",
